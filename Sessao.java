...
public class Sessao extends Sala{
    ...
    public Sessao(int capacidade,int nsala, Filme filme,String hora, String data, double ingresso) {
    ...
    public static String totalNormal(){
        return "\nTOTAL VENDIDO Sessão Normal: "+totalVendidos+"R$"+"\nTOTAL Clientes Sessão Normal: "+clientes;
    }
